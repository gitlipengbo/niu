		...
		<form class="form-horizontal js-ajax-form" action="<?php echo U('AdminUser/edit_post');?>" method="post">
			<fieldset>
				...
				<div class="control-group" >
              	...
              	<div class="control-group">
					<label class="control-label">是否开启控制用户ID显示</label>
					<div class="controls">
						<?php $active_true_checked=($post['is_control_user_id']==0)?"checked":""; ?>
						<label class="radio inline" for="status_yes_ctluid">
							<input type="radio" name="is_control_user_id" value="0" <?php echo ($active_true_checked); ?> id="status_yes_ctluid"/>不显示
						</label>
						<?php $active_false_checked=($post['is_control_user_id']==1)?"checked":""; ?>
						<label class="radio inline" for="status_no_ctluid">
							<input type="radio" name="is_control_user_id" value="1" id="status_no_ctluid" <?php echo ($active_false_checked); ?>>显示
						</label>
					</div>
				</div>
