...
function randomString(len) {
  ...
  var title  = '<?php echo ($room["id"]); ?>号九人三公房间';//分享的标题
  var shareimg = 'http://cdn.euo69.cn/themes/img/activity/test/4.png';//分享的图片
...
<textarea id="room_str" value="">牛来了 9人三公 房间号：<?php echo ($room["roomid"]); ?>'模式<?php echo ($room['wfname']); if($room['df']): ?>底分：<?php echo ($room['df']); endif; if($room['gz2']): ?>规则： <?php if(is_array($room['gz2'])): foreach($room['gz2'] as $key=>$one): echo ($one); endforeach; endif; endif; ?> ' 点击加入http://<?php echo ($_SERVER['HTTP_HOST']); ?>/portal/index/room.html?room=<?php echo ($room["id"]); ?>#num55688
</textarea>
...
<img src="http://cdn.euo69.cn/app/img/public/share.png" class="copyUrl" data-clipboard-action="copy" data-clipboard-target="#copyUrl"/> 
   ...
   <img src="/app/img/bull9/btn_game_rule.png" class="bGameRule jiurenniuniu-bGameRule" onclick="opnemm('fangjian_gz','vroomRule')" /> 
	<img src="/app/img/sangong9/btn_play_rule.png" class="bottomGameHistory" onclick="wanfas()" style="position: fixed;bottom: 0.75vh;right: 28vh;width: 4.5vh;z-index: 90;" />
