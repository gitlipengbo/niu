<?php if (!defined('THINK_PATH')) exit();?><html>
 <head> 
  ...
  <title><?php echo ($room["roomid"]); ?>号六人飘三叶房间</title> 
...
.copyUrl{  
 ...
 <script src="/app/js/homepage/home4.js" type="text/javascript"></script>
  ...
  <script src="/app/js/game5.js?t=<?php echo time(); ?>" type="text/javascript"></script> 
...
function randomString(len) {
  ...
  var title  = '<?php echo ($room["roomid"]); ?>号六人飘三张房间';//分享的标题
  var shareimg = 'http://cdn.euo69.cn/themes/img/activity/test/5.png';//分享的图片
...
<textarea id="room_str" value="">牛来了 6人飘三叶 房间号:<?php echo ($room["roomid"]); ?>'<?php if($room['gz2']): ?>牌型： <?php if(is_array($room['gz2'])): foreach($room['gz2'] as $key=>$one): echo ($one); endforeach; endif; endif; ?> <?php if($room['cm']): ?>筹码:<?php echo ($room['cm']); endif; if($room['sx']): ?>上限:<?php echo ($room['sx']); endif; ?> ' 点击加入http://<?php echo ($_SERVER['HTTP_HOST']); ?>/portal/index/room.html?room=<?php echo ($room["id"]); ?>#num55688
</textarea>
