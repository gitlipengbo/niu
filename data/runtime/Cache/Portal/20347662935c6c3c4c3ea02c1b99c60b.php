...
<head>
    ...
    <title><?php echo ($room["roomid"]); ?>号小牌九房间</title>
...
.kadunB{
  ...
  bottom:0.75vh;
    ...
    <script>
        ...
        var title  = '<?php echo ($room["roomid"]); ?> 号小牌九房间';//分享的标题
        var shareimg = 'http://'+window.location.hostname+'/themes_debug/gameserver/Public/img/activity/paijiu.png';//分享的图片
