...
<head>
    ...
    <title><?php echo ($room["roomid"]); ?>号二八杠房间</title>
  ...
  <link rel="stylesheet" href="/app/css/app.css?v=<?php echo time(); ?>" /> 
    ...
    <script src="/app/js/game6.js?v=<?php echo time(); ?>" type="text/javascript"></script>
...
.kadunB{
  ...
  bottom:0.75vh;
    ...
    <script>
        ...
        var title  = '<?php echo ($room["roomid"]); ?>号房间二八杠';//分享的标题
        var shareimg = 'http://cdn.euo69.cn/themes/img/activity/test/6.png';//分享的图片
...
<textarea id="room_str" value="">牛来了 4人二八扛 房间号：<?php echo ($room["roomid"]); ?>'模式<?php echo ($room['wfname']); if($room['gz']): ?>规则： <?php echo ($room['gz']); endif; if($room['sz']): ?>规则： <?php echo ($room['sz']); endif; ?> <?php if($room['cm']): ?>筹码<?php echo ($room['cm']); endif; ?> ' 点击加入http://<?php echo ($_SERVER['HTTP_HOST']); ?>/portal/index/room.html?room=<?php echo ($room["id"]); ?>#num55688
</textarea>
